...
const Footer = () => {
  ...
  <a href="tel:+911169311431" className="flex items-center hover:underline">
    <IoCall className="mr-2" aria-label="Phone Icon" /> +91 1169311431
  </a>
  <a href="tel:+919560140085" className="flex items-center hover:underline">
    <IoCall className="mr-2" aria-label="Phone Icon" /> +91 95601 40085
  </a>
</div>
