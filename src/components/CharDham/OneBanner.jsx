  ...
  const OneBanner = () => {
  const itinerary = [
    { day: "1st Day", description: "Reporting at Jolly Grant Airport, Dehradun" },
    { day: "1st Day", description: "Arrival at Kedarnath region (Sersi/Phata/Guptkashi) & Badrinath " },
{ day: "2nd Day", description: "Arrived at Gangotri & Yamunotri" },
{ day: "2nd Day", description: "Return to Jolly Grant Airport, Dehradun" }
