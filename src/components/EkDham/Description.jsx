      ...
      <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              { label: "Package Cost", value: "₹8,00,000  + GST PER CHARTER" },
            ].map((item, idx) => (
              <div
                key={idx}
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            {[
              "Helicopter flights from <span class='font-bold text-orange-600'>Dehradun</span> to <span class='font-bold text-orange-600'>Kedarnath</span> &  (same-day return).",
              "<span class='font-bold text-orange-600'>VIP Darshan</span> Assistance at both temples.",
              "Ground transfers at <span class='font-bold text-orange-600'>Sersi</span> .",
