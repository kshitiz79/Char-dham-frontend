  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 space-y-6">
      {formData.map((passenger, index) => {
        ...
        const qrData = `Name: ${passenger.name}, Phone: ${passenger.phone}`; // Data for QR code

        return (
          <div
            key={index}
            className="bg-blue-600 rounded-3xl shadow-lg w-full max-w-4xl flex flex-row items-stretch relative overflow-hidden border-4 border-blue-800"
          >
